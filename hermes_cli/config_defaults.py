...
DEFAULT_CONFIG = {
    ...
    "voice": {
        ...
        "auto_tts": False,
        # Realtime voice input is opt-in. It is a transcription/VAD transport
        # only; Hermes remains the conversation, tool, memory, and TTS owner.
        "input_mode": "legacy",       # legacy | realtime
        "realtime": {
            "enabled": False,
            "stt_provider": "openai",  # openai | elevenlabs
